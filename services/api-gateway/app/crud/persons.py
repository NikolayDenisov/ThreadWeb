...
def create_person(db: Session, person: schema_person.PersonCreate):
    ...
    db_person = models_persons.Person(first_name=person.first_name, last_name=person.last_name, email=person.email,
...
def create_person_sensor(db: Session, sensor: schema_sensor.SensorCreate, person_id: int):
